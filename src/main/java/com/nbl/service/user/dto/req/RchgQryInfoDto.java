...
public class RchgQryInfoDto implements Serializable {
	...
	/**
	 * 充值订单号（此值不为空时，优先做为查询条件，查询结果为1条记录）
	 */
	...
	public String toString() {
		return "RchgQryInfoDto [userId=" + userId + ", custId=" + custId + ", beginDate=" + beginDate + ", endDate="
