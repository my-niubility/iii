 ...
 * @version 1.0
 * @description :产品详情查询结果(电动车)
 */
public class PrdEleInfoRsltDto implements Serializable {

	private static final long serialVersionUID = -5224396863997497235L;
	...
	public String toString() {
		return "PrdEleInfoRsltDto [contractId=" + contractId + ", productId=" + productId + ", productNane="
				+ productNane + ", tradeTalAmt=" + tradeTalAmt + ", redEnvAmt=" + redEnvAmt + ", productName="
				+ productName + ", projectId=" + projectId + ", assetId=" + assetId + ", assetName=" + assetName
				+ ", productType=" + productType + ", collectStartDt=" + collectStartDt + ", collectEndDt="
				+ collectEndDt + ", projectStep=" + projectStep + ", projectScale=" + projectScale + ", projectAddr="
				+ projectAddr + ", projectCarbon=" + projectCarbon + ", holdPeriod=" + holdPeriod + ", rentType="
				+ rentType + ", repayRentType=" + repayRentType + ", repayRentDt=" + repayRentDt + ", lockPeriod="
				+ lockPeriod + ", nonmBackDt=" + nonmBackDt + ", contractDt=" + contractDt + ", breBackCheck="
				+ breBackCheck + ", breBackDt=" + breBackDt + ", productSubCand=" + productSubCand + ", productSubNum="
				+ productSubNum + ", productSubType=" + productSubType + ", transfers=" + transfers
