 ...
 */
public class TrdOrdDtlSolQryRsltDto extends TrdOrdDtl implements Serializable {

	private static final long serialVersionUID = 881576231800296242L;

	public TrdOrdDtlSolQryRsltDto() {
		super();
	}
	...
	public String toString() {
		return "TrdOrdDtlSolQryRsltDto [id=" + id + ", payId=" + payId + ", totalId=" + totalId + ", batchId=" + batchId
				...
				+ expectEarnRate + ", subsidySumAmt=" + subsidySumAmt + ", subsidyRate=" + subsidyRate + ", investMax="
				+ investMax + ", financeId=" + financeId + ", financeName=" + financeName + ", financeIntro="
				+ financeIntro + ", productStatus=" + productStatus + ", remark1=" + remark1 + ", remark2=" + remark2
				+ ", checkInfo=" + checkInfo + ", productCreateTime=" + productCreateTime + ", projectName="
				+ projectName + ", projectIntro=" + projectIntro + ", projectBenefit=" + projectBenefit
				+ ", projectStMes=" + projectStMes + ", rentRights=" + rentRights + ", rentTrack=" + rentTrack
				+ ", rentOperate=" + rentOperate + ", projectRemark1=" + projectRemark1 + ", projectRemark2="
				+ projectRemark2 + ", projectRemark3=" + projectRemark3 + ", projectRemark4=" + projectRemark4
