...
public class QryBnkCrdResultDto implements Serializable {

	private static final long serialVersionUID = 5034999566802743142L;
	...
	public String toString() {
		return "QryBnkCrdResultDto [id=" + id + ", custId=" + custId + ", cardName=" + cardName + ", cardNo=" + cardNo + ", cardType=" + cardType + ", bankType=" + bankType + ", createDate="
				+ createDate + ", updateTime=" + updateTime + ", isSend=" + isSend + ", status=" + status + ", isProtocol=" + isProtocol + ", isCert=" + isCert + ", authNo=" + authNo + ", branchName="
				+ branchName + ", auditStatus=" + auditStatus + ", auditBindingStatus=" + auditBindingStatus + ", firstGeo=" + firstGeo + ", secondGeo=" + secondGeo + ", createType=" + createType
				+ ", isDefault=" + isDefault + "]";
	}

	public QryBnkCrdResultDto() {
		super();
	}
