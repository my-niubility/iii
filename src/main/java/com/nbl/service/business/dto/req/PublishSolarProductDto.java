 ...
 * @version 1.0 
 * @description :发布光能产品---产品要素
 */
public class PublishSolarProductDto implements Serializable {
	
	private static final long serialVersionUID = -2255727671799536745L;
	//产品名称
	...
	public String toString() {
		return "ProductPublishBean [productName=" + productName + ", productType=" + productType + ", projectStep="
				+ projectStep + ", startdt=" + startdt + ", scale=" + scale + ", unitcost=" + unitcost + ", rate="
				+ rate + ", holdday=" + holdday + ", lockday=" + lockday + ", rentType=" + rentType + ", backday="
				+ backday + ", nonbackday=" + nonbackday + ", contrday=" + contrday + ", carbon=" + carbon
				+ ", proAddress=" + proAddress + ", proScaleMess=" + proScaleMess + ", transfer=" + transfer + "]";
	}
