 ...
 * @description :标准产品查询
 */
public class StandardProductQueryDto implements Serializable {
	
	private static final long serialVersionUID = 5818351415907662677L;
	...
	public String getActEarnRate() {
		return actEarnRate;
	}

	public void setActEarnRate(String actEarnRate) {
	...
	public String toString() {
		return "StandardProductQueryDto [productId=" + productId + ", productName=" + productName + ", assetId="
				+ assetId + ", assetName=" + assetName + ", startdt=" + startdt + ", enddt=" + enddt + ", scale="
				+ scale + ", unitcost=" + unitcost + ", rate=" + rate + ", scaleLimitFlag=" + scaleLimitFlag
				+ ", scaleLimit=" + scaleLimit + ", rentMode=" + rentMode + ", holdday=" + holdday + ", blockday="
				+ blockday + ", transferFlag=" + transferFlag + ", tlockday=" + tlockday + ", rentType=" + rentType
				+ ", backday=" + backday + ", nonbackday=" + nonbackday + ", contrday=" + contrday + ", dayFinanceAmt="
				...
				+ ", productStatus=" + productStatus + ", remainTerms=" + remainTerms + ", actEarnRate=" + actEarnRate
				+ ", redType=" + redType + ", investMin=" + investMin + ", productTittleType=" + productTittleType
				+ ", startTime=" + startTime + ", createTime=" + createTime + ", endTime=" + endTime
				+ ", financePortion=" + financePortion + "]";
	}
