...
public class TradeOrderResDto implements Serializable {

	private static final long serialVersionUID = -7988810473265296245L;
	...
	public String toString() {
		return "TradeOrderResDto [id=" + id + ", contractId=" + contractId + ", productId=" + productId + ", productNane=" + productNane + ", assetCustId=" + assetCustId + ", assetCustName="
				+ assetCustName + ", purchaseCustId=" + purchaseCustId + ", purchaseCustName=" + purchaseCustName + ", transferCustId=" + transferCustId + ", transferCustName=" + transferCustName
				+ ", invenstType=" + invenstType + ", amt=" + amt + ", tradeTalAmt=" + tradeTalAmt + ", redEnvAmt=" + redEnvAmt + ", interest=" + interest + ", principal=" + principal
				+ ", purchasePortion=" + purchasePortion + ", repayTerm=" + repayTerm +  ", tradeDate=" + tradeDate + ", orderStatus=" + orderStatus + ", transferId="
				+ transferId + ", remark=" + remark + ", createTime=" + createTime + ", updateTime=" + updateTime + "]";
	}
