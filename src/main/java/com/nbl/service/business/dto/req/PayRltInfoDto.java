...
public class PayRltInfoDto implements Serializable {

	private static final long serialVersionUID = 5314117673094939874L;
	/**
	 * 第三方支付流水号
	 */
	...
	public String toString() {
		return "PayRltInfoDto [payThdSeqNum=" + payThdSeqNum + ", paymentAcc=" + paymentAcc + ", tradeDate=" + tradeDate
