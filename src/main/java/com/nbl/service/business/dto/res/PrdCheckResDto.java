...
public class PrdCheckResDto implements Serializable {
	...
	public String toString() {
		return "PrdCheckResDto [productId=" + productId + ", productName=" + productName + ", projectId=" + projectId + ", assetId=" + assetId + ", assetName=" + assetName + ", productType="
				+ productType + ", collectStartDt=" + collectStartDt + ", collectEndDt=" + collectEndDt + ", projectStep=" + projectStep + ", projectScale=" + projectScale + ", projectAddr="
				+ projectAddr + ", projectCarbon=" + projectCarbon + ", holdPeriod=" + holdPeriod + ", rentType=" + rentType + ", repayRentType=" + repayRentType + ", repayRentDt=" + repayRentDt
				+ ", lockPeriod=" + lockPeriod + ", nonmBackDt=" + nonmBackDt + ", contractDt=" + contractDt + ", breBackCheck=" + breBackCheck + ", breBackDt=" + breBackDt + ", transfers="
				+ transfers + ", financePortion=" + financePortion + ", financeScale=" + financeScale + ", unitCost=" + unitCost + ", lockScale=" + lockScale + ", dayFinanceAmt=" + dayFinanceAmt
				+ ", confFinanceAmt=" + confFinanceAmt + ", realFinanceAmt=" + realFinanceAmt + ", establishCondition=" + establishCondition + ", establishRatio=" + establishRatio
				+ ", establishMinimum=" + establishMinimum + ", establishDate=" + establishDate + ", expectEarnRate=" + expectEarnRate + ", contractId=" + contractId + "]";
	}
