 ...
 * @version 1.0 
 * @description :发布光能产品---项目信息
 */
public class PublishSolarProjectDto implements Serializable{

	private static final long serialVersionUID = -4219869909428104312L;
	...
	public String toString() {
		return "PublishSolarProjectDto [projectName=" + projectName + ", projectBenefit=" + projectBenefit
