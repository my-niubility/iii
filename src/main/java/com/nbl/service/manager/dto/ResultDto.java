 ...
 * @version 1.0 
 * @description :管理平台执行结果
 */
public class ResultDto implements Serializable{

	private static final long serialVersionUID = 7057065244201311366L;
	...
	public ResultDto(Status status, String key, Object object, String message) {
		super();
		this.status = status;
		this.key = key;
		this.object = object;
	...
	public ResultDto(boolean success, String key, Object object, String message) {
		this(success?Status.SUCCESS:Status.FAILURE,key,object,message);
	}
	
	public ResultDto(boolean success, String key, Object object) {
