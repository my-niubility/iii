...
public class RefundDto implements Serializable {
	...
	private static final long serialVersionUID = 1437114995826790237L;
	...
	public String toString() {
		return "RefundDto [productId=" + productId + ", productName=" + productName + ", assetId=" + assetId + ", assetName=" + assetName + ", productType=" + productType + ", sellType=" + sellType
				+ ", sellRate=" + sellRate + ", transferFlag=" + transferFlag + ", subsidyDay=" + subsidyDay + ", isEstablish=" + isEstablish + ", assetRepayStatus=" + assetRepayStatus
				+ ", repayMode=" + repayMode + ", collectStartDt=" + collectStartDt + ", collectEndDt=" + collectEndDt + ", holdPeriod=" + holdPeriod + ", rentType=" + rentType + ", repayRentType="
				+ repayRentType + ", repayRentDt=" + repayRentDt + ", bLockPeriod=" + bLockPeriod + ", tLockPeriod=" + tLockPeriod + ", nonmBackDt=" + nonmBackDt + ", contractDt=" + contractDt
				+ ", breBackCheck=" + breBackCheck + ", breBackDt=" + breBackDt + ", transfers=" + transfers + ", financePortion=" + financePortion + ", financeScale=" + financeScale + ", unitCost="
				+ unitCost + ", unitCostStr=" + unitCostStr + ", lockScale=" + lockScale + ", dayFinanceAmt=" + dayFinanceAmt + ", confFinanceAmt=" + confFinanceAmt + ", realFinanceAmt="
				+ realFinanceAmt + ", establishCondition=" + establishCondition + ", establishRatio=" + establishRatio + ", establishMinimum=" + establishMinimum + ", establishDate=" + establishDate
				+ ", expectEarnRate=" + expectEarnRate + ", subsidySumAmt=" + subsidySumAmt + ", subsidyRate=" + subsidyRate + ", investMax=" + investMax + ", financeId=" + financeId
				+ ", financeName=" + financeName + ", financeIntro=" + financeIntro + ", productStatus=" + productStatus + ", productStatusCond=" + productStatusCond + ", contractId=" + contractId
				+ ", remark1=" + remark1 + ", remark2=" + remark2 + ", checkInfo=" + checkInfo + ", createTime=" + createTime + "]";
	}
