 ...
 * @version 1.0
 * 对应接口中的BillBalanceReqDto实体类
 */

public class BillBalanceReqDto implements Serializable{

	private static final long serialVersionUID = 3728459684047012178L;
	...
	public String toString() {
		return "BillBalanceReqDto [id=" + id + ", calTime=" + calTime + ", accountDate=" + accountDate + ", custId="
