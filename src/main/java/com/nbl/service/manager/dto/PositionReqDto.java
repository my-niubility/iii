...
public class PositionReqDto implements Serializable{

	private static final long serialVersionUID = 4151475003818648451L;
	...
	public String toString() {
		return "PositionBean [id=" + id + ", contractId=" + contractId + ", custId=" + custId + ", custName="
				+ custName + ", productId=" + productId + ", productNane=" + productNane + ", positionCustType="
				+ positionCustType + ", orderId=" + orderId + ", subjectNo=" + subjectNo + ", subjectType="
				+ subjectType + ", possessPortion=" + possessPortion + ", initialPortion=" + initialPortion
				+ ", unitCost=" + unitCost + ", invenstAmt=" + invenstAmt + ", remainCapital=" + remainCapital
				+ ", transferOutAmt=" + transferOutAmt + ", recAmt=" + recAmt + ", earningAmt=" + earningAmt
				+ ", expectEarning=" + expectEarning + ", holdStatus=" + holdStatus + ", remainTerms=" + remainTerms
				+ ", expireDate=" + expireDate + ", remark=" + remark + ", investType=" + investType
