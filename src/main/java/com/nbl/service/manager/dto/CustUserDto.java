...
public class CustUserDto implements Serializable{
	...
	private static final long serialVersionUID = 7333770168996350098L;
	...
	public String toString() {
		return "CustUserDto [id=" + id + ", loginName=" + loginName + ", password=" + password + ", mobile=" + mobile
				...
				+ ", loginDate=" + loginDate + ", custId=" + custId + ", custType=" + custType + ", certStatus="
				+ certStatus + ", lastUpdatePasswordTime=" + lastUpdatePasswordTime + ", lastLoginLockTime="
				+ lastLoginLockTime + ", description=" + description + "]";
	}
