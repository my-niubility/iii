...
public class CustBankReqDto implements Serializable{

	private static final long serialVersionUID = 3184471225601670537L;
	...
	public String toString() {
		return "CustBankBean [id=" + id + ", custId=" + custId + ", cardName=" + cardName + ", cardNo=" + cardNo
				+ ", cardType=" + cardType + ", bankType=" + bankType + ", createDate=" + createDate + ", updateTime="
				+ updateTime + ", isSend=" + isSend + ", status=" + status + ", isProtocol=" + isProtocol + ", isCert="
				+ isCert + ", authNo=" + authNo + ", branchName=" + branchName + ", auditStatus=" + auditStatus
				+ ", auditBindingStatus=" + auditBindingStatus + ", firstGeo=" + firstGeo + ", secondGeo=" + secondGeo
				+ ", createType=" + createType + ", isDefault=" + isDefault + "]";
	}
