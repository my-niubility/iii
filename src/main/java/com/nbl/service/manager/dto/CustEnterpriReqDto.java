...
public class CustEnterpriReqDto implements Serializable{

	private static final long serialVersionUID = -3679649454939305402L;
	...
	public String toString() {
		return "CustEnterpriseBean [id=" + id + ", name=" + name + ", credentialsType=" + credentialsType
				+ ", phone=" + phone + ", fax=" + fax + ", address=" + address + ", summary=" + summary
				+ ", companyImg=" + companyImg + ", organiztionImg=" + organiztionImg + ", taxImg=" + taxImg
				+ ", bankAccImg=" + bankAccImg + ", status=" + status + ", certStatus=" + certStatus + ", prStatus="
				+ prStatus + ", legalpersonId=" + legalpersonId + ", legalpersonBackId=" + legalpersonBackId
				+ ", legalpersonMobile=" + legalpersonMobile + ", companyPoaId=" + companyPoaId + ", agentId="
				+ agentId + ", agentBackId=" + agentBackId + ", agentName=" + agentName + ", agentMobile="
				+ agentMobile + ", updateDate=" + updateDate + ", createdDate=" + createdDate + "]";
	}
}
