...
public class PositionDto implements Serializable {
	...
	private static final long serialVersionUID = -6945801957771316408L;
	...
	public String toString() {
		return "PositionDto [id=" + id + ", contractId=" + contractId + ", custId=" + custId + ", custName=" + custName + ", productId=" + productId + ", productNane=" + productNane
				+ ", positionCustType=" + positionCustType + ", orderId=" + orderId + ", subjectNo=" + subjectNo + ", subjectType=" + subjectType + ", possessPortion=" + possessPortion
				+ ", initialPortion=" + initialPortion + ", unitCost=" + unitCost + ", invenstAmt=" + invenstAmt + ", remainCapital=" + remainCapital + ", transferOutAmt=" + transferOutAmt
				+ ", recAmt=" + recAmt + ", earningAmt=" + earningAmt + ", expectEarning=" + expectEarning + ", holdStatus=" + holdStatus + ", holdStatusCond=" + holdStatusCond + ", remainTerms="
				+ remainTerms + ", expireDate=" + expireDate + ", remark=" + remark + ", investType=" + investType + ", createTime=" + createTime + ", updateTime=" + updateTime + "]";
	}
}
