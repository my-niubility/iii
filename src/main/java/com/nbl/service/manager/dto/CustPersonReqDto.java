...
public class CustPersonReqDto implements Serializable{
...
private String id;
	...
	public String toString() {
		return "CustPersonBean [id=" + id + ", payPassword=" + payPassword + ", registeredType=" + registeredType
				+ ", name=" + name + ", credentialsType=" + credentialsType + ", identityCardNumber="
				+ identityCardNumber + ", certExpiryDate=" + certExpiryDate + ", countryId=" + countryId + ", ip=" + ip
				+ ", cityCode=" + cityCode + ", cityName=" + cityName + ", nickname=" + nickname + ", gender=" + gender
				+ ", birthday=" + birthday + ", maritalStatus=" + maritalStatus + ", ethnicGroup=" + ethnicGroup
				+ ", partyAffiliation=" + partyAffiliation + ", bloodType=" + bloodType + ", height=" + height
				+ ", weight=" + weight + ", profession=" + profession + ", investmentExp=" + investmentExp
				+ ", annualIncome=" + annualIncome + ", status=" + status + ", certStatus=" + certStatus
				+ ", createdTime=" + createdTime + ", regChanCode=" + regChanCode + ", num=" + num + "]";
	}
}
